...
try {
  ...
  $sql = "
    SELECT u.pseudo, u.sex, u.height_cm, u.relationship_status,
...
$statusLabel = null;
if ($row['relationship_status'] === 'single') $statusLabel = 'Célibataire';
elseif ($row['relationship_status'] === 'couple') $statusLabel = 'En couple';
  ...
  echo json_encode([
    ...
    'sex'            => $sexLabel,   // "Homme" | "Femme" | null
    'height_cm'      => $height,     // int | null
