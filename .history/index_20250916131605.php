...
<form method="get" action="index.php" style="display:flex;gap:8px;align-items:center">
  ...
  <?php if (!empty($tagSlug)): ?><input type="hidden" name="tag" value="<?php echo htmlspecialchars($tagSlug,ENT_QUOTES); ?>"><?php endif; ?>
  <input name="q" value="<?php echo htmlspecialchars($q ?? '', ENT_QUOTES); ?>" placeholder="Rechercher...">
  <button class="btn" type="submit">Rechercher</button>
  <?php if (!empty($q)): ?><a class="btn" href="index.php<?php echo $mine?'?mine=1':''; ?>" style="background:#374151">Effacer</a><?php endif; ?>
</form>
