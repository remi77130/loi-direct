<?php
// login.php — Connexion sécurisée avec rate-limit & ban IP
...
const IP_MAX_FAILS      = 10;       // échecs autorisés dans la fenêtre
const IP_BAN_SECONDS    = 15 * 60;  // durée de ban auto

/* -------------------- Helpers -------------------- */
/**
 * IP client : si tu es derrière un reverse proxy *de confiance* qui renseigne X-Forwarded-For.
 * N'active la branche XFF que si le proxy est sûr (sinon c'est forgeable).
 */
...
/** Prolonge ou crée un ban IP jusqu’à NOW + seconds */
...
/** Nombre d’échecs récents pour l’IP */
...
/* -------------------- Hygiène (optionnel) -------------------- */
// Purge des tentatives > 30 jours (coûts très faibles ici)
