...
// Requête principale en DISTINCT (évite les doublons dus aux tags)

$sql = "SELECT DISTINCT p.id, p.title, p.summary, p.published_at, u.pseudo AS author, COALESCE(l.cnt,0) AS likes_count
        FROM law_projects p
        $joins
        WHERE $where
