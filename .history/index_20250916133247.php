...
<header>
  ...
  <nav class="nav">
    ...
    <a href="<?= APP_BASE ?>/index.php" class="<?php echo !$mine?'active':'';?>">Récents</a>
     <a href="<?= APP_BASE ?>/index.php?mine=1" class="<?php echo $mine?'active':'';?>">Mes projets</a>
  ...
  <form method="get" action="<?= APP_BASE ?> style="display:flex;gap:8px;align-items:center">
  ...
  <?php if ($q !== ''): ?>
   <a class="btn" href="<?= APP_BASE ?>/index.php<?php echo $mine?'?mine=1':''; ?>" style="background:#374151">Effacer</a>
    <?php endif; ?>
</form>
  ...
  <div>
    ...
    <a class="btn" ... href="<?= APP_BASE ?>/logout.php">Se déconnecter</a>
  </div>
</header>
